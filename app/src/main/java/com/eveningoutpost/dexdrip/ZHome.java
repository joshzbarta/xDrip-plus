...
public class ZHome extends ActivityWithMenu implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private ActivityZhomeBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xdrip.checkForcedEnglish(ZHome.this);

        super.onCreate(savedInstanceState);
        setTheme(R.style.AppThemeToolBarLite); // for toolbar mode


        Injectors.getZHomeShelfComponent().inject(this);
        ...
        binding = ActivityZhomeBinding.inflate(getLayoutInflater());
        binding.setVs(homeShelf);
        binding.setZhome(this);
        binding.setUi(ui);
        ...
        final ZHome home = this;
        mToolbar.setLongClickable(true);
        mToolbar.setOnLongClickListener(v -> {
            // show configurator
            final ActivityZhomeShelfSettingsBinding binding = ActivityZhomeShelfSettingsBinding.inflate(getLayoutInflater());
            final Dialog dialog = new Dialog(home);
            dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
            binding.setVs(homeShelf);
            binding.setZhome(home);
        ...
        checkBadSettings();
        // lower priority
        PlusSyncService.startSyncService(getApplicationContext(), "ZHomeOnCreate");
    ...
    public static void updateStatusLine(String key, String value) {
        ...
        Log.d(TAG, "ZHome Status update: " + key + " / " + value);
    }
    ...
    static void startIntentThreadWithDelayedRefresh(final Intent intent) {
        ...
        JoH.runOnUiThreadDelayed(ZHome::staticRefreshBGCharts, 4000);
    }
...
// in case of a single injection in a treatment, assume thats the #units to send to pendiq
    ...
    private void processIncomingBundle(Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            if (bundle.getString(WatchUpdaterService.WEARABLE_APPROVE_TREATMENT) != null || watchkeypad)
                ...
                cancelTreatment();
            else if (bundle.getString(ZHome.START_SPEECH_RECOGNITION) != null) promptSpeechInput();
            else if (bundle.getString(ZHome.START_TEXT_RECOGNITION) != null) promptTextInput_old();
            else if (bundle.getString(ZHome.CREATE_TREATMENT_NOTE) != null) {
                try {
                    showNoteTextInputDialog(null, Long.parseLong(bundle.getString(ZHome.CREATE_TREATMENT_NOTE)), JoH.tolerantParseDouble(bundle.getString(ZHome.CREATE_TREATMENT_NOTE + "2"), 0));
                } catch (NullPointerException e) {
            ...
            } else if (bundle.getString(ZHome.HOME_FULL_WAKEUP) != null) {
                if (!JoH.isScreenOn()) {
            ...
            } else if (bundle.getString(ZHome.GCM_RESOLUTION_ACTIVITY) != null) {
                GcmActivity.checkPlayServices(this, this);
            } else if (bundle.getString(ZHome.SNOOZE_CONFIRM_DIALOG) != null) {
            ...
            } else if (bundle.getString(ZHome.BLUETOOTH_METER_CALIBRATION) != null) {
                try {
                    processFingerStickCalibration(JoH.tolerantParseDouble(bundle.getString(ZHome.BLUETOOTH_METER_CALIBRATION), 0d),
                            JoH.tolerantParseDouble(bundle.getString(ZHome.BLUETOOTH_METER_CALIBRATION + "2"), -1d),
                            bundle.getString(ZHome.BLUETOOTH_METER_CALIBRATION + "3") != null && bundle.getString(ZHome.BLUETOOTH_METER_CALIBRATION + "3").equals("auto"));
                } catch (NumberFormatException e) {
                    JoH.static_toast_long(gs(R.string.number_error_) + e);
                }
            } else if (bundle.getString(ZHome.ACTIVITY_SHOWCASE_INFO) != null) {
            ...
            } else if (bundle.getString(ZHome.BLOOD_TEST_ACTION) != null) {
                ...
                final String bt_uuid = bundle.getString(ZHome.BLOOD_TEST_ACTION + "2");
                if (bt_uuid != null) {
                    ...
                    if (bt != null) {
                        ...
                        builder.setPositiveButton(gs(R.string.calibrate), (dialog, which) -> {
                            ...
                            ZHome.startZHomeWithExtra(xdrip.getAppContext(), ZHome.BLUETOOTH_METER_CALIBRATION, BgGraphBuilder.unitized_string_static(bt.mgdl), Long.toString(time_since));
                        ...
                        builder.setNegativeButton(R.string.delete, (dialog, which) -> {
                            ...
                            builder1.setPositiveButton(gs(R.string.yes_delete), (dialog12, which12) -> {
                                ...
                                GcmActivity.syncBloodTests();
                                if (ZHome.get_show_wear_treatments())
            ...
            } else if (bundle.getString(ZHome.ENABLE_STREAMING_DIALOG) != null) {
                NFCReaderX.enableBluetoothAskUser(mActivity);
            } else if (bundle.getString(ZHome.CHOOSE_INSULIN_PEN) != null) {
                ChooseInsulinPenDialog.show(this, bundle.getString(ZHome.CHOOSE_INSULIN_PEN));
            }
        }
    }
    ...
    public static void startZHomeWithExtra(Context context, String extra, String text) {
        startZHomeWithExtra(context, extra, text, "");
    }

    public static void startZHomeWithExtra(Context context, String extra, String text, String even_more) {
        startZHomeWithExtra(context, extra, text, even_more, "");
    }

    public static void startZHomeWithExtra(Context context, String extra, String text, String even_more, String even_even_more) {
        Intent intent = new Intent(context, ZHome.class);
...
/*        LayoutInflater inflater = (LayoutInflater) xdrip.getAppContext().getSystemService(LAYOUT_INFLATER_SERVICE);
    ...
    public static void toaststaticnext(final String msg) {
        nexttoast = msg;
        UserError.Log.uel(TAG, "ZHome toast message next: " + msg);
    }
...
/*
    ...
    private void updateCurrentBgInfo(final String source) {
        ...
        if (reset_viewport) {
          ...
          //  holdViewport.set(0, 0, 0, 0);
			...
			// TODO check if above reset viewport thing is defunct now
        }
        setupCharts(source);
        ...
        if (!isSensorActive) {
            ...
            if ((dialog == null) || (!dialog.isShowing())) {
                ...
                if (!Experience.gotData() && Experience.backupAvailable() && JoH.ratelimit("restore-backup-prompt", 10)) {
                    ...
                    if (showPrompt && !Experience.gotData() && !QuickSettingsDialogs.isDialogShowing() && !notConnectedToG6Yet && JoH.ratelimit("start-sensor_prompt", 20)) {
    ...
    public void exportDatabase(MenuItem myitem) {
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                int permissionCheck = ContextCompat.checkSelfPermission(ZHome.this,
                        Manifest.permission.READ_EXTERNAL_STORAGE);
                if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(ZHome.this,
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected void onPostExecute(String filename) {
                        ...
                        if (filename != null) {
                            ...
                            Toast.makeText(ZHome.this, gs(R.string.could_not_export_csv_), Toast.LENGTH_LONG).show();
                        }
                    }
                }.execute();
            }
    ...
    public void showNoteTextInputDialog(View view, final long timestamp, final double position) {
        ...
        dialogBuilder.setPositiveButton(R.string.done, (dialog, whichButton) -> {
            ...
            if (treatment_text.length() > 0) {
                ...
                final View.OnClickListener mOnClickListener = v -> ZHome.startZHomeWithExtra(xdrip.getAppContext(), ZHome.CREATE_TREATMENT_NOTE, Long.toString(timestamp), Double.toString(position));
                ZHome.snackBar(R.string.add_note, getString(R.string.added) + ":    " + treatment_text, mOnClickListener, mActivity);
            }
    ...
    private View.OnClickListener makeSnackBarUriLauncher(final Uri uri, final String text) {
        return v -> {
            ...
            ZHome.this.startActivity(Intent.createChooser(shareIntent, text));
        };
    }

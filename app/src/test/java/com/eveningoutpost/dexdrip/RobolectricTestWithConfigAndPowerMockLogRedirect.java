...
@PowerMockIgnore({"org.mockito.*", "org.robolectric.*", "android.*", "com.activeandroid.*", "com.eveningoutpost.dexdrip.zmodels.*"})
@PrepareForTest({android.util.Log.class, com.eveningoutpost.dexdrip.data.UserError.class})
...
public abstract class RobolectricTestWithConfigAndPowerMockLogRedirect {
    ...
    public void setupLogging() {
        ...
        try {
            PowerMockito.whenNew(com.eveningoutpost.dexdrip.data.UserError.class).withAnyArguments().thenReturn(null);
        } catch (Exception e) {

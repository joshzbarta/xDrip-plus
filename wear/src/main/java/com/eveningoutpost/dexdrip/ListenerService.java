...
import com.eveningoutpost.dexdrip.zutilitymodels.BgSendQueue;
import com.eveningoutpost.dexdrip.zutilitymodels.Blukon;
...
import com.eveningoutpost.dexdrip.zutilitymodels.WearSyncBooleans;
import com.eveningoutpost.dexdrip.zutilitymodels.WearSyncPersistentStrings;
...
import static com.eveningoutpost.dexdrip.zutilitymodels.BgSendQueue.doMgdl;
import static com.eveningoutpost.dexdrip.zutilitymodels.BgSendQueue.extraStatusLine;
import static com.eveningoutpost.dexdrip.zutilitymodels.BgSendQueue.resendData;
import static com.eveningoutpost.dexdrip.zutilitymodels.BgSendQueue.sgvLevel;
...
public class ListenerService extends WearableListenerService implements GoogleApiClient.ConnectionCallbacks,
        ...
        if (dataMap != null) {
            ...
            if (last != null) {
                ...
                if (bgTimestamp > dmTimestamp) {
                    dataMap(dataMap, last, mPrefs, new com.eveningoutpost.dexdrip.zutilitymodels.BgGraphBuilder(context));
                    return true;
                }
            }
        }
    ...
    private static void dataMap(DataMap dataMap, BgReading bg, SharedPreferences sPrefs, com.eveningoutpost.dexdrip.zutilitymodels.BgGraphBuilder bgGraphBuilder) {//KS
